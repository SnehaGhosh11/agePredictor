...
from sklearn.linear_model import LogisticRegression  # Linear regression replaced by logistic regression
...
models = {
    ...
    'Linear Gradient Boosting': HistGradientBoostingClassifier(),
    'Logistic Regression': LogisticRegression(max_iter=1000)  # Logistic regression added
}

# DataFrame to store results for y_test vs y_pred
...
for model_name, model in models.items():
    ...
    results_df[model_name + '_y_pred'] = y_pred

# Save the y_test vs y_pred comparison to CSV
results_df.to_csv('C:/mycode/agepredictor/datasets/y_test_vs_y_pred.csv', index=False)

print("y_test vs y_pred saved to CSV file.")